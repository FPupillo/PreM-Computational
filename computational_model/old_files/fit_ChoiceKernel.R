...
fit_ChoiceKernel<-function(data,alphaBound, betaBound, initialCK){
  
  #------------------------------------------------------------------------------------------------#
  # This function finds the parameters that 
  # minimize the negative log-likelihood
  # for the choice kernel function
  #
  # Input    
  ...
  obfunc<-function(x) lik_ChoiceKernel(data, x[1], x[2],1, initialCK)

lik_RescorlaWagner_obsALLstick<-function (Data,alpha, beta, omega, print,  initialQ, initialU){
  
# This function computes the likelihood of the participants'
# choices conditional on the Rescorla Wagner model.  
# in this version, the values are updated depending on which category is shown in the end, regardless of the feedb.
# even when there is no response. in this version we also have the stickiness parameter
#
# Input
#   Data: a long dataset where each row represents a trial. 
#   alpha: a candidate alpha parameter 
#   beta: a candidate beta parameter
#   omega: a candidate omega
...
#   setup: type of the setup (pilot, priors, flat,three)
#  
# Output:

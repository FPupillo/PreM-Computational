lik_RescorlaWagner_feedbALL<-function(
  Data,
  alpha = NULL,
  beta = NULL,
  omega = NULL,
...
# in this version, the values are updated depending on the feedback participants
# received on the category that predicted. All the categories are updated accordingly
# only when there is a response
#
# Input

...
ggsave(paste0(abs, "/figures/PEdistr_fLR_instr_byID.exp1.png"))

ggplot(exp2, aes(x=PE))+ geom_histogram()+theme_bw()+
  facet_wrap(.~SubNum)

ggsave(paste0(abs, "/figures/PEdistr_fLR_instr_byID.exp2.png"))
...
# first, analyse prediction outcome by PE
...
ggsave(paste0(abs,  "/figures/PE_mem_fLR_instr.exp1.png")
       ,width = 7, height = 7)
...
ggsave(paste0(abs,  "/figures/PE_mem_fLR_instr.exp2.png"), 
       width = 7, height = 7)
...
ggplot(allData, aes( x=num_subs_scene, y=id_acc))+
  ...
  theme(legend.position = "none")+
  xlab("Number of Subsequent Similar Contexts")+
  ylab("p(Hit)")

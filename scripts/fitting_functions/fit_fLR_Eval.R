...
fit_fLR_Eval<-function(data,alphaBound, betaBound, initialQ ){
  ...
  #   [[2]] "loglikel": log-likelihood for the model with the parameters of 
  #           best fit
  ...
  obfunc<-function(x) lik_fLR_Eval(data, x[1], x[2],1, initialQ) 
